...
function testEntropyType(done, entropyText, entropyTypeUnsafe) {
    ...
    driver.sleep(generateDelay).then(function() {
        driver.findElement(By.css('.entropy-container'))
            .getText()
            .then(function(text) {
                // ADDED "i" TO IGNORE CSS UPPERCASE FORMATTING
                var re = new RegExp("Entropy Type\\s+" + entropyType, "i");
...
function testEntropyBits(done, entropyText, entropyBits) {
    ...
    driver.sleep(generateDelay).then(function() {
        driver.findElement(By.css('.entropy-container'))
            ...
            .then(function(text) {
                // ADDED "i" TO IGNORE CSS UPPERCASE FORMATTING
                var re = new RegExp("Total Bits\\s+" + entropyBits, "i");
                expect(text).toMatch(re);
                done();
            });
    });
                ...
                driver.findElement(By.css('.phrase'))
                    ...
                    .then(function(phrase) {
                        if ("filtered" in entropyDetail) {
                            ...
                            var re = new RegExp(reText, "i"); // ADDED "i"
                            expect(text).toMatch(re);
                        }
                        if ("type" in entropyDetail) {
                        ...
                        if ("bitsPerEvent" in entropyDetail) {
                            var key = "Avg Bits/Event"; // UPGRADED FROM "Bits Per Event"
